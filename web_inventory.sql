...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Bulan Mei 2025 pada 13.01
...
INSERT INTO `tb_daftar_produk` (`id_produk`, `nama_produk`, `jenis_produk`, `perusahaan_produk`, `jenis_satuan`, `banyak_produk`) VALUES
('P-001', 'Tango Wafer', 'Makanan', 'Orang Tua', 'PCS', 5),
('P-002', 'Milku', 'Minuman', 'WingsFood', 'PCS', 6);
...
(100, 'alec', '202cb962ac59075b964b07152d234b70', 'alec sefano', 'User'),
(101, 'reza', '202cb962ac59075b964b07152d234b70', 'rezaaa', 'User');
